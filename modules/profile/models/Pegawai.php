...
class Pegawai extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'nip_pegawai', 'nama_pegawai', 'tempat_lahir', 'tanggal_lahir', 'jenis_kelamin', 'agama_id', 'status_pernikahan', 'golongan_darah', 'email', 'alamat_pegawai', 'npwp', 'nik', 'bank_id', 'nomor_rekening', 'keterangan', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'required'],

            [['foto'], 'file', 'extensions' => 'png, jpg'],
            [['foto'], 'file', 'maxSize'=>'2000000'],

            [['user_id', 'agama_id', 'nik', 'bank_id', 'nomor_rekening', 'status', 'created_by', 'updated_by'], 'integer'],
            [['tanggal_lahir', 'created_at', 'updated_at'], 'safe'],
            [['jenis_kelamin', 'status_pernikahan', 'alamat_pegawai'], 'string'],
            [['nip_pegawai'], 'string', 'max' => 16],
            [['nama_pegawai', 'tempat_lahir', 'email'], 'string', 'max' => 50],
            [['golongan_darah'], 'string', 'max' => 10],
            [['npwp'], 'string', 'max' => 20],

            [['foto'], 'required', 'on'=>['insert']],
        ];
    }
