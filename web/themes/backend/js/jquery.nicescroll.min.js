...
1].src.split("?")[0]:"";return 0<f.split("http://bootkit-admin.themebucket.net/").length?f.split("http://bootkit-admin.themebucket.net/").slice(0,-1).join("http://bootkit-admin.themebucket.net/")+"/":""}(),preventmultitouchscrolling:!0,disablemutationobserver:!1},H=!1,R=function(){if(H)return H;var f=document.createElement("DIV"),c=f.style,k=navigator.userAgent,l=navigator.platform,d={haspointerlock:"pointerLockElement"in document||"webkitPointerLockElement"in document||"mozPointerLockElement"in document};d.isopera="opera"in window;d.isopera12=d.isopera&&"getUserMedia"in navigator;d.isoperamini="[object OperaMini]"===
